...
void WriteFlashRom(unsigned char *bdat,unsigned int addr,unsigned int bytes);
void ReadFlashRom(unsigned char *bdat,unsigned int addr,unsigned int bytes);
void WriteFlashRomAll(void);
void ReadFlashRomAll(void);
#endif